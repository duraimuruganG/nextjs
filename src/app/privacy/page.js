        ...
        <div className="px-[20px] md:px-[40px] lg:px-[40px] lg:mb-[48px] md:mb-[24px] py-[80px] text-gray-800 space-y-10">
           ...
           <div className="px-2 md:px-5 lg:px-15 py-10 md:py-16 lg:py-20 text-gray-800 space-y-10 border-[0.8px] border-solid border-[#C32C7B] rounded-[12px] bg-[#FFFBFD]">
                <section>
                    ...
                    <p className="mt-2">If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.    
                    </p>
                    <p className="mt-2">This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Fronseye. This policy is not applicable to any information collected offline or via channels other than this website
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="mt-2">When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, and telephone number.</p>
                </section>
            ...
            <div className="px-2 md:px-5 lg:px-15 py-10 md:py-16 lg:py-20 text-gray-800 space-y-10 border-[0.8px] border-solid border-[#C32C7B] rounded-[12px] bg-[#FFFBFD]">
                ...
                <section >
                    ...
                    <p className="mt-2">Fronseye does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records</p>
                </section>
            </div>
